...
public class DecodeEngine {
    ...
    public static final String TAG = "DecodeEngine";
    ...
    private boolean decodeMusicFile(String musicFileUrl, String decodeFileUrl,
        ...
        LogUtils.i(TAG, "歌曲信息Track info: mime:"
                + mime
                + " 采样率sampleRate:"
                + sampleRate
                + " channels:"
        ...
        if (TextUtils.isEmpty(mime) || !mime.startsWith("audio/")) {
            LogUtils.i(TAG, "解码文件不是音频文件mime:" + mime);
            return false;
        }
        ...
        if (duration <= 0) {
            LogUtils.i(TAG, "音频文件duration为" + duration);
            return false;
        }
    ...
    private void getDecodeData(MediaExtractor mediaExtractor, MediaCodec mediaCodec,
        ...
        while (!decodeOutputEnd) {
            ...
            try {
                ...
                LogUtils.i(TAG, "getDecodeData异常" + e);
            }
        }
        ...
        if (bufferedOutputStream != null) {
            try {
                ...
                LogUtils.i(TAG, "关闭bufferedOutputStream异常" + e);
            }
        }
