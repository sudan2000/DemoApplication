...
class TickerColumn {
    ...
    private TickerCharacterList mCharacterList;
    ...
    TickerColumn(TickerCharacterList characterLists, TickerDrawMetrics metrics) {
        this.mCharacterList = characterLists;
    ...
    private void setCharacterIndices() {
        ...
        final TickerCharacterList.CharacterIndices indices =
                mCharacterList.getCharacterIndices(currentChar, targetChar);
        if (indices != null) {
            this.currentCharacterList = mCharacterList.getCharacterList();
