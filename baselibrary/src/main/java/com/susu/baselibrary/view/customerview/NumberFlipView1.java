 ...
 * Description:
 */
public class NumberFlipView1 extends androidx.appcompat.widget.AppCompatTextView {
    //高位快
    ...
    public NumberFlipView1(Context context) {
        super(context);
    }

    public NumberFlipView1(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public NumberFlipView1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    private void drawNumber(Canvas canvas) {
        for (int j = 0; j < numLength; j++) {
            for (int i = 1; i < maxLine; i++) {
                ...
                if (overLine[j] == 0) {
                    LogUtils.e("lmtlmt", setBack(arrayListText.get(j), maxLine - i - 1) + "");
