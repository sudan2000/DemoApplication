...
public class CommonUtil {
    ...
    public static void saveCurrentLocation() {
        SharedPreferences.Editor editor = getTrackConfig().edit();
        ...
        editor.putString(LocationConstants.LAST_LOCATION, locationInfo.toString());
        editor.apply();
    }
    ...
    public static SharedPreferences getTrackConfig() {
        return CoreUtils.getApp().getSharedPreferences("track_conf", MODE_PRIVATE);
    }
